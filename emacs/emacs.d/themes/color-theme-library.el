  ...
  (color-theme-install
   '(color-theme-cdu
     ...
     ((buffers-tab-face . buffers-tab)
      ...
      (cperl-pod-head-face . font-lock-variable-name-face)
      (vc-mode-face . highlight))
     (default ((t (:background "black" :foreground "light grey"))))
     (blue ((t (:foreground "blue"))))
     (bold ((t (:bold t))))
     (bold-italic ((t (:bold t))))
     (border-glyph ((t (nil))))
     ...
     (font-lock-constant-face ((t (:foreground "light slate gray"))))
     (font-lock-doc-string-face ((t (:foreground "yellow"))))
     (font-lock-function-name-face ((t (:foreground "gray55"))))
